...
void D3DDrv_CreateImage( const image_t* image, const byte *pic, bool isLightmap );
void D3DDrv_DeleteImage( const image_t* image );
void D3DDrv_UpdateCinematic( const image_t* image, const byte* pic, int cols, int rows, bool dirty );
